    ...
    <div className="parent pt-16 my-16">
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          >
            <img
              src="https://user-images.githubusercontent.com/132304001/240701154-0017fe28-0002-4e79-86e6-32b3d2c01567.png"
              alt="Braydon Liu"
          ...
          >
            <h1 className="text-4xl font-semibold mb-4 text-center translate-y-[-380%] sm:translate-y-[-0%] sm:text-3xl sm:mb-2 md:text-left">Braydon Liu</h1>
            <div className="my-8">
              <TypeAnimation
